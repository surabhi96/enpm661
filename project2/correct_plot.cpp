...
//   // polygon - rhombus
//   if (x*(7/5.0)+y-120 > 0 && x*(-6/5.0)+y+10 < 0 && 
//     x*(6/5)+y-170 < 0 && x*(-7/5)+y+90 > 0)
//   {
//   // cout<<"rhom poly"<<endl;
//     return true;}
...
//   // polygon - triangle1
//   if (y-15 > 0 && x*(7/5.0)+y-120 < 0 && x*(-7/5.0)+y+20 < 0)
//   {
//     // cout<<"poly t1"<<endl;
//     return true;
//   }
...
//   // polygon - triangle2
//   if (y+(13*x)-340 > 0 && x+y-100 < 0 && x*(-7/5)+y+20 > 0)
//   {
//     // cout<<"poly t2"<<endl;
//     return true;
//   }
...
//   // rectangle -angled
//   if ((200-y) - (1.73)*x + 135 > 0 && (200-y) + (0.58)*x - 96.35  <= 0 && 
//     (200-y) - (1.73)*x - 15.54 <= 0 && (200-y) + (0.58)*x - 84.81 >= 0)
//   {
//   // cout<<"rectangle"<<endl;
//     return true;
// }
//   // circle 
//   if ((pow((x-225.0),2) + pow((y-50.0),2) < (pow(25,2)))
...
//   // ellipse
//   if    (((  (pow((x-150.0),2)/1600) + (pow((y-100.0),2)/400) )) <= 1)
//   {
//     cout<<"ellipse"<<endl;
//     return true;
//   }
